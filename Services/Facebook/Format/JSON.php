 ...
 */
class Services_Facebook_Format_JSON implements Services_Facebook_Format_Interface
{

    /**
     * Format 
     * 
     * Format a JSON reponse into an array
     *
    ...
    public function format(SimpleXMLElement $xml)
    {
        ...
        return json_decode($string->format($xml));
    }
