...
/**
 * Services_Facebook_Format_ArrayInt
 *
 ...
 */
class Services_Facebook_Format_ArrayInt implements Services_Facebook_Format_Interface
{
    ...
    {
        $int    = Services_Facebook_Format::factory('Int');
        $result = array();
        foreach ($xml as $item) {
