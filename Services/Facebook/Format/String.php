...
/**
 * Services_Facebook_Format_String
 *
 * Formats a string
 *
 * @category Services
 ...
 */
class Services_Facebook_Format_String implements Services_Facebook_Format_Interface
{
     ...
     *
     * @return string String format of the response
     */
